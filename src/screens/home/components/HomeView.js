            ...
            <Card style={styles}>
                ...
                <CardItem>
                    <Body>
                        ...
                        <Button onPress={this.props.lightsOn}>
                            <Text>On</Text>
                        </Button>
                        <Button onPress={this.props.lightsOff}>
                            <Text>Off</Text>
                        </Button>
                    </Body>
                </CardItem>
                    ...
                    <Container>
                        ...
                        {this.props.videoWidth && this.props.videoHeight &&
                            <>
                                ...
                                <Svg height="50%" width="50%" viewBox={`0 0 ${this.props.videoWidth} ${this.props.videoHeight}`}>
                                  <Rect
                                    x="15"
                                    y="15"
                                    width="70"
